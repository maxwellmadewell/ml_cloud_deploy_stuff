...
STARTAPP = '/home/mxmcoursey/gcp_forkPyThenSendPub/start_pipeline_task.py'

script_path = os.path.abspath(os.path.join(os.getcwd(), STARTAPP))
print("[TRIGGER] {} - Triggered by Topic, {}".format(STARTAPP, TOPIC))

start_pipeline = "python -u %s" % script_path

# TODO - removed - GCP boilerplate cloud_handler.py is outdated NOT working
...
print("[PUBWATCH] Watching Topic: {}".format(TOPIC))
